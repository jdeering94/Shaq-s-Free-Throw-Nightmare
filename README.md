...
Not a bug per se, but the code needs refactoring in the laser firing function as I have nested functions and it seems messy, it would be the main area I would focus on if I wanted to improve this project.
